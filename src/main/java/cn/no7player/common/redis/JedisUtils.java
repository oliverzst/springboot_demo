...
import cn.no7player.common.utils.ObjectUtils;
import cn.no7player.common.utils.StringUtils;
...
public class JedisUtils {
	...
	public static void returnBrokenResource(Jedis jedis) {
		try {
			...
			e.printStackTrace();
			logger.debug("returnBrokenResource error:" + e.getMessage());
		}finally {
			//jedisPool.close();
		}
	}
	...
	public static void returnResource(Jedis jedis) {
		try {
			...
			e.printStackTrace();
			logger.debug("returnResource error:" + e.getMessage());
		}finally {
			//jedisPool.close();
		}
	}
